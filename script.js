function initializePageInteractions() {
  ...
  const platformVideo = document.getElementById("platform-video");

  if (exploreBtn && videoModal && closeVideoBtn && platformVideo) {
    const openVideo = () => {
    ...
    exploreBtn.addEventListener("click", openVideo);
